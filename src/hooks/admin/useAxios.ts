...
const methodMapping = new Map([
   [RequestMethod.POST, ["201", "add"]],
   [RequestMethod.PATCH, ["200", "edit"]],
   [RequestMethod.DELETE, ["200", "delete"]],
])
...
export const useAxios = (): UseAxiosType => {
   ...
   const handleAxiosRequest = async (method: RequestMethod, endpoint: string, modalToggle: DialogToggleType, formData?: FormDataType): Promise<void> => {
      toggleLoading(true)
